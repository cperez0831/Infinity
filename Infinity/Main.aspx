    ...
    <asp:Panel ID="pnlData" runat="server" Visible="true">
        <div id="GridScroll" class="grid_scroll">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT [Verified], [IDInfinity], [Defendant_Company], [Lead_Case_Venue], [Judge_Assigned_to_Lead_Case], [Magistrate_Judge], [Lead_Counsel_1_] FROM [Infinity] WHERE [DeletedRecord] = 0 ORDER BY [Defendant_Company]"
